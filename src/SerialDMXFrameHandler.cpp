...
SerialDMXFrameHandler::SerialDMXFrameHandler(IDMXOutput& dmxOutput, uint16_t targetUniverse)
    : _dmxOutput(dmxOutput),
...
int SerialDMXFrameHandler::getFrameRate() const {
    return currentFps;
}
